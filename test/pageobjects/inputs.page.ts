...
class KeyPressesPage extends Page {
    ...
    public async enterDateTags() {
        ...
        await helpers.setValueAdv(await this.fldTarget, "next week is <today+7> and last week was <today-7>");
        await helpers.setValueAdv(await this.fldTarget, "Last year is <today-365>");
    }
}
